...
import com.fakevideocall.fakechat.prank.fake.call.app.activity.LanguageActivity;
import com.fakevideocall.fakechat.prank.fake.call.app.activity.SplashActivity;
import com.fakevideocall.fakechat.prank.fake.call.app.activity.message.ChatActivity;
...
public class Application extends AdsApplication {
    ...
    public void onCreate() {
        ...
        AppOpenManager.getInstance().disableAppResumeWithActivity(ChatActivity.class);
        AppOpenManager.getInstance().disableAppResumeWithActivity(VideoCallActivity.class);
